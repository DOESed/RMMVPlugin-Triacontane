 ...
 * @author トリアコンタン
 *
 * @help 擊破敵人時可以獲得一些獎勵回饋。
 * 可以製作成擊破敵人時回復HP、MP的裝備或狀態。
 *
 * 在具有如下特徵的數據庫的注釋欄中描述。
 ...
 * <KB_Gold:5>         # 增加金錢 5 G。
 * <KB_State:5>        # 自身賦予狀態ID[5]。
 * <KB_StateAll:5>     # 我方全體賦予狀態ID[5]。
 * <KB_StateEnemy:5>   # 敵方全體賦予狀態ID[5]。
 * <KB_Script:script>  # 任意的JavaScript執行。
 *
 * 同時只能附加一個擊破獎勵條件。
 * <KB_Cond:NoDamage>     # 沒有受到傷害的擊破獎勵
 * <KB_Cond:NoSkill>      # 沒有使用技能的擊破獎勵
 * <KB_Cond:NoDeath>      # 沒有戰鬥不能的擊破獎勵
 * <KB_Cond:1>            # 開關ID[1]為ON時的擊破獎勵
 *
 * 這個插件沒有插件命令。
 *
 * 利用規約：
